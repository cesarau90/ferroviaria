...
function Shell({user,onLogout}:{user:User;onLogout:()=>void}) {
  ...
  return <div className="flex min-h-screen">
    ...
    <div className="min-w-0 flex-1 lg:ml-64">
      ...
      <main className="p-4 sm:p-6"><Routes><Route path="/" element={<Dashboard/>}/><Route path="/trips" element={<Trips user={user}/>}/><Route path="/trips/:id" element={<ControlCenter user={user}/>}/><Route path="/wagons" element={<Wagons/>}/><Route path="/devices" element={<Devices/>}/><Route path="/alerts" element={<Alerts user={user}/>}/><Route path="/audit" element={<Audit/>}/><Route path="/simulator" element={<Simulator user={user}/>}/><Route path="/users" element={<UsersPage/>}/><Route path="*" element={<Navigate to="/"/>}/></Routes></main>
    </div>
  </div>
}
